...
[specification](../specifications/ANIMALS.01-animal-register.md#api---session-3);
...
[the API section of the spec](../specifications/ANIMALS.01-animal-register.md#api---session-3)
